...
class Lab2Spec(lab2: Lab2Like) extends FlatSpec {
  ...
  it should "treat an empty string as 0" in{
    val e1 = S("")
    val e2 = N(5)
    val e3 = eval(Binary(Minus,e1,e2))
    assert(e3 == N(-5))
  ...
  it should "return Infinity when zero is in the denominator" in {
    val e1 = N(9)
    val e2 = N(0)
    val e3 = eval(Binary(Div, e1, e2))
  ...
  it should "return NaN when both expressions are 0" in {
    val e1 = N(0)
    val e2 = N(0)
    val e3 = eval(Binary(Div, e1, e2))
  ...
  it should "return true is both are undefined" in {
    val e1 = Undefined
    val e2 = Undefined
    val e3 = eval(Binary(Eq, e1, e2))
    assert(e3 === B(true))
  ...
  it should "return true if two string are in alphabetical order" in {
    val e1 = S("a")
    val e2 = S("b")
    val e3 = eval(Binary(Lt,e1,e2))
    assert(e3 === B(true))
  ...
  it should "return true if two string are in reverse alphabetical order" in {
    val e1 = S("b")
    val e2 = S("a")
    val e3 = eval(Binary(Gt,e1,e2))
    assert(e3 === B(true))
  ...
  it should "return -0 for 0 expression" in{
    val e1 = N(0)
    val e2 = eval(Unary(Neg,e1))
    assert(e2 === N(-0))
  }
